...
TEST_CASE("Format: Standard Name", "[tag][format][standard name]")
{
    ...
    // -- British
    // -- Canadian
    CHECK(to_standard_name(Pantag(/*TODO*/)) == "oganesson-294");
    CHECK(to_standard_name(Pantag(/*TODO*/), /*IUPAC*/) == "oganesson-294");
    CHECK(to_standard_name(Pantag(/*TODO*/), /*TODO:American*/) == "oganesson-294");
    CHECK(to_standard_name(Pantag(/*TODO*/), /*TODO:British*/) == "oganesson-294");
    CHECK(to_standard_name(Pantag(/*TODO*/), /*TODO:Canadian*/) == "oganesson-294");
    ...
    CHECK(to_standard_name(Pantag(/*TODO*/)) == "photon");
