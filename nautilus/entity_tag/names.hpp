...
namespace nautilus::entity_tag::names {
...
// This lets you use (for example) `names::nitrogen` instead of `7` if you can't remember what the
// atomic number of nitrogen is.  This list gives us all IUPAC symbols (standard capitalization),
// all IUPAC names, and all variant spellings available from Nuclides.
...
ELEMENT_INDEX(He);
ELEMENT_INDEX(helium);
ELEMENT_INDEX(Li);
ELEMENT_INDEX(lithium);
ELEMENT_INDEX(Be);
ELEMENT_INDEX(beryllium);
ELEMENT_INDEX(B);
ELEMENT_INDEX(boron);
ELEMENT_INDEX(C);
ELEMENT_INDEX(carbon);
ELEMENT_INDEX(N);
ELEMENT_INDEX(nitrogen);
ELEMENT_INDEX(O);
ELEMENT_INDEX(oxygen);
ELEMENT_INDEX(F);
ELEMENT_INDEX(fluorine);
ELEMENT_INDEX(Ne);
ELEMENT_INDEX(neon);
ELEMENT_INDEX(Na);
ELEMENT_INDEX(sodium);
ELEMENT_INDEX(Mg);
ELEMENT_INDEX(magnesium);
ELEMENT_INDEX(Al);
ELEMENT_INDEX(aluminium);
ELEMENT_INDEX(aluminum);
ELEMENT_INDEX(Si);
ELEMENT_INDEX(silicon);
ELEMENT_INDEX(P);
ELEMENT_INDEX(phosphorus);
ELEMENT_INDEX(S);
ELEMENT_INDEX(sulfur);
ELEMENT_INDEX(sulphur);
ELEMENT_INDEX(Cl);
ELEMENT_INDEX(chlorine);
ELEMENT_INDEX(Ar);
ELEMENT_INDEX(argon);
ELEMENT_INDEX(K);
ELEMENT_INDEX(potassium);
ELEMENT_INDEX(Ca);
ELEMENT_INDEX(calcium);
ELEMENT_INDEX(Sc);
ELEMENT_INDEX(scandium);
ELEMENT_INDEX(Ti);
ELEMENT_INDEX(titanium);
ELEMENT_INDEX(V);
ELEMENT_INDEX(vanadium);
ELEMENT_INDEX(Cr);
ELEMENT_INDEX(chromium);
ELEMENT_INDEX(Mn);
ELEMENT_INDEX(manganese);
ELEMENT_INDEX(Fe);
ELEMENT_INDEX(iron);
ELEMENT_INDEX(Co);
ELEMENT_INDEX(cobalt);
ELEMENT_INDEX(Ni);
ELEMENT_INDEX(nickel);
ELEMENT_INDEX(Cu);
ELEMENT_INDEX(copper);
ELEMENT_INDEX(Zn);
ELEMENT_INDEX(zinc);
ELEMENT_INDEX(Ga);
ELEMENT_INDEX(gallium);
ELEMENT_INDEX(Ge);
ELEMENT_INDEX(germanium);
ELEMENT_INDEX(As);
ELEMENT_INDEX(arsenic);
ELEMENT_INDEX(Se);
ELEMENT_INDEX(selenium);
ELEMENT_INDEX(Br);
ELEMENT_INDEX(bromine);
ELEMENT_INDEX(Kr);
ELEMENT_INDEX(krypton);
ELEMENT_INDEX(Rb);
ELEMENT_INDEX(rubidium);
ELEMENT_INDEX(Sr);
ELEMENT_INDEX(strontium);
ELEMENT_INDEX(Y);
ELEMENT_INDEX(yttrium);
ELEMENT_INDEX(Zr);
ELEMENT_INDEX(zirconium);
ELEMENT_INDEX(Nb);
ELEMENT_INDEX(niobium);
ELEMENT_INDEX(Mo);
ELEMENT_INDEX(molybdenum);
ELEMENT_INDEX(Tc);
ELEMENT_INDEX(technetium);
ELEMENT_INDEX(Ru);
ELEMENT_INDEX(ruthenium);
ELEMENT_INDEX(Rh);
ELEMENT_INDEX(rhodium);
ELEMENT_INDEX(Pd);
ELEMENT_INDEX(palladium);
ELEMENT_INDEX(Ag);
ELEMENT_INDEX(silver);
ELEMENT_INDEX(Cd);
ELEMENT_INDEX(cadmium);
ELEMENT_INDEX(In);
ELEMENT_INDEX(indium);
ELEMENT_INDEX(Sn);
ELEMENT_INDEX(tin);
ELEMENT_INDEX(Sb);
ELEMENT_INDEX(antimony);
ELEMENT_INDEX(Te);
ELEMENT_INDEX(tellurium);
ELEMENT_INDEX(I);
ELEMENT_INDEX(iodine);
ELEMENT_INDEX(Xe);
ELEMENT_INDEX(xenon);
ELEMENT_INDEX(Cs);
ELEMENT_INDEX(caesium);
ELEMENT_INDEX(cesium);
ELEMENT_INDEX(Ba);
ELEMENT_INDEX(barium);
ELEMENT_INDEX(La);
ELEMENT_INDEX(lanthanum);
ELEMENT_INDEX(Ce);
ELEMENT_INDEX(cerium);
ELEMENT_INDEX(Pr);
ELEMENT_INDEX(praseodymium);
ELEMENT_INDEX(Nd);
ELEMENT_INDEX(neodymium);
ELEMENT_INDEX(Pm);
ELEMENT_INDEX(promethium);
ELEMENT_INDEX(Sm);
ELEMENT_INDEX(samarium);
ELEMENT_INDEX(Eu);
ELEMENT_INDEX(europium);
ELEMENT_INDEX(Gd);
ELEMENT_INDEX(gadolinium);
ELEMENT_INDEX(Tb);
ELEMENT_INDEX(terbium);
ELEMENT_INDEX(Dy);
ELEMENT_INDEX(dysprosium);
ELEMENT_INDEX(Ho);
ELEMENT_INDEX(holmium);
ELEMENT_INDEX(Er);
ELEMENT_INDEX(erbium);
ELEMENT_INDEX(Tm);
ELEMENT_INDEX(thulium);
ELEMENT_INDEX(Yb);
ELEMENT_INDEX(ytterbium);
ELEMENT_INDEX(Lu);
ELEMENT_INDEX(lutetium);
ELEMENT_INDEX(Hf);
ELEMENT_INDEX(hafnium);
ELEMENT_INDEX(Ta);
ELEMENT_INDEX(tantalum);
ELEMENT_INDEX(W);
ELEMENT_INDEX(tungsten);
ELEMENT_INDEX(Re);
ELEMENT_INDEX(rhenium);
ELEMENT_INDEX(Os);
ELEMENT_INDEX(osmium);
ELEMENT_INDEX(Ir);
ELEMENT_INDEX(iridium);
ELEMENT_INDEX(Pt);
ELEMENT_INDEX(platinum);
ELEMENT_INDEX(Au);
ELEMENT_INDEX(gold);
ELEMENT_INDEX(Hg);
ELEMENT_INDEX(mercury);
ELEMENT_INDEX(Tl);
ELEMENT_INDEX(thallium);
ELEMENT_INDEX(Pb);
ELEMENT_INDEX(lead);
ELEMENT_INDEX(Bi);
ELEMENT_INDEX(bismuth);
ELEMENT_INDEX(Po);
ELEMENT_INDEX(polonium);
ELEMENT_INDEX(At);
ELEMENT_INDEX(astatine);
ELEMENT_INDEX(Rn);
ELEMENT_INDEX(radon);
ELEMENT_INDEX(Fr);
ELEMENT_INDEX(francium);
ELEMENT_INDEX(Ra);
ELEMENT_INDEX(radium);
ELEMENT_INDEX(Ac);
ELEMENT_INDEX(actinium);
ELEMENT_INDEX(Th);
ELEMENT_INDEX(thorium);
ELEMENT_INDEX(Pa);
ELEMENT_INDEX(protactinium);
ELEMENT_INDEX(U);
ELEMENT_INDEX(uranium);
ELEMENT_INDEX(Np);
ELEMENT_INDEX(neptunium);
ELEMENT_INDEX(Pu);
ELEMENT_INDEX(plutonium);
ELEMENT_INDEX(Am);
ELEMENT_INDEX(americium);
ELEMENT_INDEX(Cm);
ELEMENT_INDEX(curium);
ELEMENT_INDEX(Bk);
ELEMENT_INDEX(berkelium);
ELEMENT_INDEX(Cf);
ELEMENT_INDEX(californium);
ELEMENT_INDEX(Es);
ELEMENT_INDEX(einsteinium);
ELEMENT_INDEX(Fm);
ELEMENT_INDEX(fermium);
ELEMENT_INDEX(Md);
ELEMENT_INDEX(mendelevium);
ELEMENT_INDEX(No);
ELEMENT_INDEX(nobelium);
ELEMENT_INDEX(Lr);
ELEMENT_INDEX(lawrencium);
ELEMENT_INDEX(Rf);
ELEMENT_INDEX(rutherforium);
ELEMENT_INDEX(Db);
ELEMENT_INDEX(dubnium);
ELEMENT_INDEX(Sg);
ELEMENT_INDEX(seaborgium);
ELEMENT_INDEX(Bh);
ELEMENT_INDEX(bohrium);
ELEMENT_INDEX(Hs);
ELEMENT_INDEX(hassium);
ELEMENT_INDEX(Mt);
ELEMENT_INDEX(meitnerium);
ELEMENT_INDEX(Ds);
ELEMENT_INDEX(darmstadtium);
ELEMENT_INDEX(Rg);
ELEMENT_INDEX(roentgenium);
ELEMENT_INDEX(Cn);
ELEMENT_INDEX(copernicium);
ELEMENT_INDEX(Nh);
ELEMENT_INDEX(nihonium);
ELEMENT_INDEX(Fl);
ELEMENT_INDEX(flerovium);
ELEMENT_INDEX(Mc);
ELEMENT_INDEX(moscovium);
ELEMENT_INDEX(Lv);
ELEMENT_INDEX(livermorium);
ELEMENT_INDEX(Ts);
ELEMENT_INDEX(tennessine);
ELEMENT_INDEX(Og);
