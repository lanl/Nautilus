...
//       elements to construct the EntityTag.  To be clear, the tests should do this for some
//       cases, but it would be nice if we could do something like `EntityTag(Co, 59)` (and if we
//       implement this feature, it should also be tested).
